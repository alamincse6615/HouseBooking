...
import com.wu.housebooking.adapter.FavoritePropertyAdapter;
...
public class FavoriteActivity extends AppCompatActivity {
    ...
    FavoritePropertyAdapter adapter;
        ...
        lastQuery.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull @NotNull DataSnapshot snapshot) {
                ...
                if (itemPropertyArrayList.size()>0){
                    adapter = new FavoritePropertyAdapter(FavoriteActivity.this, itemPropertyArrayList);
                    rv_my_property.setLayoutManager(new LinearLayoutManager(FavoriteActivity.this, LinearLayoutManager.VERTICAL, false));
                    rv_my_property.setAdapter(adapter);
                }
            }
            @Override

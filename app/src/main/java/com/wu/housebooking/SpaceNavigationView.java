...
import com.wu.housebooking.carvelayout.CentreButton;
import com.wu.housebooking.carvelayout.SpaceOnClickListener;
import com.wu.housebooking.carvelayout.SpaceOnLongClickListener;
...
public class SpaceNavigationView extends RelativeLayout {
    ...
    private void addSpaceItems(LinearLayout leftContent, LinearLayout rightContent) {
        ...
        for (int i = 0; i < spaceItems.size(); i++) {
            ...
            RelativeLayout badgeContainer = textAndIconContainer.findViewById(R.id.badge_container);
